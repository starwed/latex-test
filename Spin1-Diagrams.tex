...
%FIXME add eqref to spin one-half lagrangian
...
%%% A_i terms
%FIXME redundancy: this needs to refer back to some previous section
\subsubsection{Transformation of $\v{A}$ terms in $\Mq$}
%TODO probably this identity is developed elsewhere, refer back to it.
...
%FIXME diagarms -- wrong polarisation states
$V_\lambda = $
\begin{minipage}{1in}
