...
\beq
	m^2 W_i - \frac{e^2 [g-1]^2}{m^2} W^j E^j E^i
...
i D_0 \spinor{W}{\eta} = 
	...
	{ - \lambda \frac{e}{m^2} \left [ \v{D} \cdot \v{E} - (\v{S} \cdot \v{D}) (\v{S} \cdot \v{E}) + i \v{S} \cdot \v{D} \times \v{E} \right ]  } \spinor{W}{\eta}
\eeq
...
%FIXME check definition of \eta --- W_{i0} or W_{0i}
...
An operator is defined as Hermitian with respect to a particular inner product.  One generalisation of the normal inner product from quantum mechanics is found by allowing a weight matrix $M$ inserted between the wave functions:
\beq
...
H' \Upsilon' = 
	\Mblock
	{ e\Phi + \lambda \frac{e}{m^2} \left [ -i \v{E} \cdot \gv{\pi} + i  (\v{S} \cdot \v{E})( \v{S} \cdot \gv{\pi}) +  \v{S} \cdot \v{E} \times \v{\pi} \right ] }
		{m
	+\frac{1}{m} (\v{S} \cdot \gv{\pi})^2 
	- \lambda \frac{e}{m} \v{S} \cdot \v{B}
	+ \lambda^2 \frac{e^2}{m^3} \left [ \v{E}^2 - (\v{S} \cdot \v{E})^2 \right ]  }
	{ m
	+ \frac{1}{m}\left [ \gv{\pi}^2 - (\v{S} \cdot \gv{\pi})^2 - e \v{S} \cdot \v{B} \right ]  }
	{ e\Phi  - \lambda \frac{e}{m^2} \left [  - i\gv{\pi} \cdot \v{E} + i (\v{S} \cdot \gv{\pi}) (\v{S} \cdot \v{E}) +  \v{S} \cdot \gv{\pi} \times \v{E} \right ]  } \spinor{W}{\eta}
\eeq
 \normalsize  
...
\int d^3 x (\Upsilon_u^\dagger \Upsilon_u - {\Upsilon^\dagger}_\ell \Upsilon_\ell)  
	&=& \int d^3 x (\Upsilon_u^\dagger \Upsilon_u - (\epsilon {\Upsilon_u})^\dagger \epsilon \Upsilon_u) \\
	&=& \int d^3 x \Upsilon_u^\dagger (1 + \mathcal{O}(v^4)) \Upsilon_u
\eeqa
...
\beqa
(E -m)\Upsilon_u 	
	&=&	\left(H_{11} +  \frac{1}{2m}H_{12} H_{21} \right) \Upsilon_u\\
(E-m)(1-\Delta)\phis
