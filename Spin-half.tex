...
\beqaL \label{eq:Sh:SAi}
	\frac{A_i (p + p')^i}{2m} \srb \sr  &=& - \frac{\v{A} \cdot (\v{p} + \v{p'} ) }{2m} w^\dagger \left( 
		1 -  \frac{ \v{p}^2  +2 \v{p} \cdot \v{p'} +  \v{p'}}{8m^2} - \frac{i\gv{\sigma} \cdot \v{q} \times \v{p} }{4m^2} 
		\right ) w	\\
	 &=&	- w^\dagger  \left [ \frac{e \v{A} \cdot (\v{p} + \v{p'} ) }{2m} \left(1 - \frac{\v{p}^2}{4m^2} \right )  \right ]w^\dagger 
	- w^\dagger  \left [  \frac{ 	 e (\gv{\sigma} \cdot  \v{p})( \v{B} \cdot \v{p}) - e \v{p}^2 \gv{\sigma} \cdot \v{B} }{4m^2} \right ] w \nonumber
\eeqaL
...
\beqaL  \label{eq:Sh:TAi}
	A_i \srb  \frac{i}{2m} q_j \sigma^{ij} \sr 
		&=& \frac{i \epsilon_{ijk} A_i q_j}{2m} w^\dagger \left \{
			\sigma_k - \frac{ \gv{\sigma} \cdot \v{p} p_k  }{2m^2} 
		\right \} w \\ 
		&=&  - w^\dagger \left \{ 
...
\begin{split}
	e A_i \srb \Gamma^i \sr = & 
		 ...
		 \frac{ \v{A} \cdot (\v{p} + \v{p'}) + \gv{\sigma} \cdot \v{B} }{2m} \left(1 - \frac{\v{p}}{2m^2} \right ) 
	\right\} w
	\\& - e F_2  w^\dagger \left \{ \frac{ \gv{\sigma} \cdot \v{B} }{2m} - \frac{ (\gv{\sigma} \cdot \v{p}) (\v{B} \cdot \v{p}) }{4m^2}
			\right \} w
\end{split}
\eeq
...
\beq \begin{split}
	e A_i \srb \Gamma^i \sr = & 
		- e [F_1 + F_2] w^\dagger \left \{
		 \frac{  \v{A} \cdot (\v{p} + \v{p'}) +  \gv{\sigma} \cdot \v{B} }{2m} \left(1 - \frac{\v{p}}{2m^2} \right ) 
	\right\} w
	\\& + e F_2 w^\dagger  \left [ \frac{e \v{A} \cdot (\v{p} + \v{p'} ) }{2m} \left(1 - \frac{\v{p}^2}{4m^2} \right )  \right ]w^\dagger 
	+ eF_2 w^\dagger  \left [  \frac{ 	 e (\gv{\sigma} \cdot  \v{p})( \v{B} \cdot \v{p}) - e \v{p}^2 \gv{\sigma} \cdot \v{B} }{4m^2} \right ] w
\end{split} \eeq
The third combination is $\Gamma^\mu = \frac{p^\mu  + p'^\mu }{2m} F_1(q^2) + i \frac{\sigma^{\mu\nu}q_\nu}{2m} [F_1(q^2) + F_2(q^2) ] $.  Using \eqref{eq:Sh:SAi} and \eqref{eq:Sh:TAi}
\beq \begin{split}
	e A_i \srb \Gamma^i \sr = & 
		 e F_1 w^\dagger  \left [ \frac{e \v{A} \cdot (\v{p} + \v{p'} ) }{2m} \left(1 - \frac{\v{p}^2}{4m^2} \right )  \right ]w^\dagger
		 + e F_1 w^\dagger  \left [  \frac{ (\gv{\sigma} \cdot  \v{p})( \v{B} \cdot \v{p}) - e \v{p}^2 \gv{\sigma} \cdot \v{B} }{4m^2} \right ] w
	\\&	-[F_1 + F_2] w^\dagger \left \{ \frac{ \gv{\sigma} \cdot \v{B} }{2m} - \frac{ (\gv{\sigma} \cdot \v{p}) (\v{B} \cdot \v{p}) }{4m^2}
			\right \} w
\end{split} \eeq
...
\section{Amplitude in NRQED for scattering off an external field}
...
\section{Calculation of Compton scattering in QED}
