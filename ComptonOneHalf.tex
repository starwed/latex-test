...
$\underbrace{ \begin{minipage}{1.3in}
  \begin{center} \includegraphics[scale=0.9]{eps/Tree-crossed-square} \end{center}
\end{minipage}}_I$
$\hspace{1em}   +  \hspace{1em} $
$\underbrace{\begin{minipage}{1.3in}
   \begin{center} \includegraphics[scale=0.5]{eps/Tree-uncrossed-square} \end{center} 
\end{minipage}}_{II}$
$\hspace{1em}   +  \hspace{1em} $
$\underbrace{\begin{minipage}{1.3in}
   \begin{center} \includegraphics[scale=0.8]{eps/two-photon-nrqed} \end{center} 
\end{minipage}}_{III}$
...
$	 \hspace{1em} =	\hspace{1em}	 $
\begin{minipage}{1.5in}
   \begin{center} \includegraphics[scale=0.5]{eps/PlainTree} \end{center}
\end{minipage}
$\hspace{1em}   +  \hspace{1em} $
\begin{minipage}{1.5in}
   \begin{center}\includegraphics[scale=0.5]{eps/Zdiag} \end{center}
\end{minipage}
} 
\vspace{1em}
