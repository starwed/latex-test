...
\usepackage{setspace}
\DoubleSpacing
\title{Universality of Leading Relativistic Corrections to Bound State Gyromagnetic Ratios}
...
\include{NRQED-review}
\include{Spin-half}
\include{SpinOne-Equations}
\include{Spin1-Diagrams}
%\include{NRQED}
\include{GeneralSpin}
\include{breit}
