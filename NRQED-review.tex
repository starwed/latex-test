...
\begin{minipage}{1.6in}
   \center{\includegraphics[scale=0.8]{eps/QED-static-field-blob}} 
\end{minipage}
$	=	\hspace{1em} 	 $
\begin{minipage}{1.6in}
  \center{ \includegraphics[scale=0.8]{eps/NRQED-static-coulomb-field}}
\end{minipage}
$\hspace{1em}   +  \hspace{1em} $
\begin{minipage}{1.6in}
  \center{ \includegraphics[scale=0.8]{eps/NRQED-static-vector-field}}  
\end{minipage}
} 
\vspace{1em}
